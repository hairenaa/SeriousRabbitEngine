...
class LightGameObject:public DefaultGameObject
{
public:
	enum HandleType
	{
	...
	LightGameObject(std::string _name, Shader* _shader) :DefaultGameObject(_name, _shader)
	{
	}

	LightGameObject(std::string _name) :DefaultGameObject(_name)
	{
	}
